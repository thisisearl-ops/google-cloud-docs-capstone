...
import {
  Bot, Sparkles, MessageSquare, FileText, Database, ShieldAlert, Terminal,
  ArrowRight, Code, ArrowUpRight, Search, Play, FileTerminal, MapPin,
  SearchCheck, LayoutTemplate, BookOpen, Filter, Workflow, Tag,
  LayoutDashboard, Cloud, Key, ChevronDown, Plus, Mic, ScanSearch,
  Image, Paperclip, Globe, RefreshCw, Timer, MonitorPlay,
} from 'lucide-react';
import clsx from 'clsx';
import gcLogo from 'figma:asset/e6145855ce50e374bc43bbd031450497dcc259f8.png';
...
function TaskCard({ title, description, icon, links, titleLink, twoColumnLinks, popularResourcesLinks, highlight }: TaskCardProps) {
  const [hovered, setHovered] = useState(false);
